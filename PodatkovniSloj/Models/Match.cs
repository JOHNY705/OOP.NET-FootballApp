namespace OOP.net_projekt.Models
{
    ...
    //public partial class Match
    //{
    //    public static Match FromJson(string json) => JsonConvert.DeserializeObject<Match>(json, MatchConverter.Settings);
    //}

    //public static class MatchSerialize
    //{
    //    public static string ToJson(this Match self) => JsonConvert.SerializeObject(self, MatchConverter.Settings);
    //}
